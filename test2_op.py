"""
Optuna hyperparameter tuning for test2.py.
"""
...
FIX_SEED = 2026
DEFAULT_CHECKPOINTS_ROOT = "./checkpoints_test2_optuna/"
DEFAULT_RESULTS_ROOT = "./results_test2_optuna/"
DEFAULT_OPTUNA_OUTPUT_ROOT = "./optuna_runs/"
DEFAULT_OPTUNA_STUDY_NAME = "test2_optuna_v1"
DEFAULT_OPTUNA_N_TRIALS = 128
DEFAULT_OPTUNA_TIMEOUT = 0
DEFAULT_OPTUNA_DIRECTION = "minimize"

DEFAULT_USE_DIR = "./optuna"
USE_BEST_PARAMS_FILE = "best_params2.json"
USE_BEST_CONFIG_FILE = "best_config2.json"
USE_BEST_WEIGHT_FILE = "best_model2.pth"
USE_BEST_TRIAL_FILE = "best_trial_result2.json"
...
def build_cli_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Optuna hyperparameter tuning for test2.py")
    parser.add_argument(
        "--weather-source",
        type=str,
